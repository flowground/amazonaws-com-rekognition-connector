# ![LOGO](logo.png) Amazon Rekognition MSP Connector

## Description

A generated MSP connector for the Amazon Rekognition API (version 2016-06-27).
...
flowground :- Telekom iPaaS / amazonaws-com-rekognition-connector<br/>
